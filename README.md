...
* **Business Acumen:** Ability to translate data trends into strategic recommendations such as risk mitigation and revenue optimization.
...
| :--- | :--- | :--- |
| [**Amazon Sales Performance**](https://github.com/Imam-Data/Amazon-Sales-Performance-Analysis) | **End-to-End SQL & PBI Project**. Analyzed 100k transactions. Uncovered **$91.83M total revenue** and identified **Credit Card** as the payment method with the highest risk of cancellation (1,083 orders). | SQL (Database Management), Power BI (DAX & Interactive Design), Operational Risk Analysis |
